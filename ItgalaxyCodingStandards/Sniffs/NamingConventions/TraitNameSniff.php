...
class TraitNameSniff implements \PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (substr($name, -5) !== 'Trait') {
            $warn = 'Traits names should always have the suffix "Trait"';
            $phpcsFile->addError($warn, $stackPtr, 'InvalidTraitName');
        }
    }
}
