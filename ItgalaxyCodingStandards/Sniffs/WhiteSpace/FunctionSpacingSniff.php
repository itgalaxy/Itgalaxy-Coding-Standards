...
// Todo rename
// Todo new line before class https://github.com/dereuromark/codesniffer-standards/blob/master/CakePHP/Sniffs/WhiteSpace/ClassSpacingSniff.php
...
class FunctionSpacingSniff implements \PHP_CodeSniffer_Sniff
{
    ...
    public function process(\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        */
        ...
        // Allow for comments on the same line as the closer. // Todo
        ...
        if ($foundLines !== $this->spacing) {
            if ($tokens[$nextLineToken]['code'] === T_CLOSE_CURLY_BRACKET
                && isset($tokens[$nextLineToken]['scope_condition'])
                && $tokens[$tokens[$nextLineToken]['scope_condition']]
            ) {
                return;
            }
