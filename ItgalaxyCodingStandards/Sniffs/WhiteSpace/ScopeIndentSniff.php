...
class ScopeIndentSniff implements \PHP_CodeSniffer_Sniff
{
    ...
    public function process(\PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($this->tabWidth === null) {
            ...
            if (isset($cliValues['tabWidth']) === false || $cliValues['tabWidth'] === 0) {
                ...
                $this->tabWidth = $cliValues['tabWidth'];
            }
        }
                ...
                if ($tokens[$parenCloser]['line'] !== $tokens[$parenOpener]['line']) {
                    ...
                    if (isset($tokens[$parenCloser]['conditions']) === true
                        ...
                        if ($this->debug === true) {
                            ...
                            echo "\t* token is inside condition "
                                . $condition
                                . '('
                                . $type
                                . ') on line'
            ...
            if ($checkToken !== null
                ...
                if (isset($adjustments[$first]) === true
                    ...
                    if ($this->debug === true) {
                        ...
                        echo "\t=> Add adjustment of "
                            . $adjustments[$checkToken]
                            . ' for token '
                            . $checkToken
                            . ' ('
                            . $type
            ...
            if (isset($tokens[$i]['scope_condition']) === true
                ...
                if ($prev === false) {
                    ...
                    if ($prev === false) {
                        ...
                        if ($this->debug === true) {
                            echo "\t* could not find a previous T_EQUAL or T_RETURN token; will use current token *"
                                . PHP_EOL;
                        }
                    }
                }
